...
typedef VOID (*PBL_COPY_MEMORY)(OUT PVOID Destination, IN PCVOID Source, IN SIZE_T Length);
...
typedef VOID (*PBL_SET_MEMORY)(OUT PVOID Destination, IN UCHAR Byte, IN SIZE_T Length);
...
typedef VOID (*PBL_ZERO_MEMORY)(OUT PVOID Destination, IN SIZE_T Length);
